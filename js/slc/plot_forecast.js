async function getForecast(code) {
    ...
    var url = 'https://api.weather.gov/gridpoints/' + code;
...
function plotForecast(d) {
    ...
    Plotly.newPlot('graphForecast', data, layout, config)

}

var code = document.getElementById('graphForecast').getAttribute('data-siteID');
// console.log(code)

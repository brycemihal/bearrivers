var sID = document.getElementById('plotTemperatureGCD').getAttribute('data-siteID');
// console.log(siteID)
// console.log(obs[siteID])
var ObsDT = obs[sID].map(x => x.Datetime);
var ObsDV = obs[sID].map(x => x.Temperature);
...
Plotly.newPlot('plotTemperatureGCD', data2);
